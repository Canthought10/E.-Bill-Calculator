    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(name) || TextUtils.isEmpty(numberOfDays) || TextUtils.isEmpty(totalAmount)) {
                Toast.makeText(MainActivity8.this, "Please fill in all fields.", Toast.LENGTH_SHORT).show();
                return;
            }

            // Ensure the number of days is numeric
            if (!isNumeric(numberOfDays)) {
                Toast.makeText(MainActivity8.this, "Please enter a valid number of days.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    response -> {
                        try {
                            ...
                            Toast.makeText(MainActivity8.this, message, Toast.LENGTH_SHORT).show();
                        } catch (JSONException e) {
                            Toast.makeText(MainActivity8.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    },
                    error -> {
                        error.printStackTrace();
                        Toast.makeText(MainActivity8.this, "Request failed: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }) {
        ...
        back.setOnClickListener(view -> {
            ...
            pay.setText("");
            named.setText("");
            Intent z = new Intent(MainActivity8.this, MainActivity10.class);
            startActivity(z);
        });
