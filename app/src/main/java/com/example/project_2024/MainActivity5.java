    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(view -> {
            ...
            if (!isNumeric(numberOfDays)) {
                Toast.makeText(MainActivity5.this, "Please enter a valid number of days.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    error -> {
                        ...
                        Toast.makeText(MainActivity5.this, "Request failed: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }) {
        ...
        back.setOnClickListener(view -> {
            ...
            pay.setText("");
            named.setText("");
            Intent z = new Intent(MainActivity5.this, MainActivity10.class);
            startActivity(z);
        });
