    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(view -> {
            ...
            if (!isNumeric(numberOfDays)) {
                Toast.makeText(MainActivity6.this, "Please enter a valid number of days.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    response -> {
                        try {
                            ...
                            Toast.makeText(MainActivity6.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    },
                    error -> {
                        error.printStackTrace();
                        Toast.makeText(MainActivity6.this, "Request failed: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }) {
        ...
        back.setOnClickListener(view -> {
            ...
            pay.setText("");
            named.setText("");
            Intent z = new Intent(MainActivity6.this, MainActivity10.class);
            startActivity(z);
        });
